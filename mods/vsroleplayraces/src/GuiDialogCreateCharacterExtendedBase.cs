...
{
    public class GuiDialogCreateCharacterExtendedBase : GuiDialog
    {
        ...
        public GuiDialogCreateCharacterExtendedBase(ICoreClientAPI capi, CharacterSystem modSys) : base(capi)
        {
            this.modSys = modSys;
        }
