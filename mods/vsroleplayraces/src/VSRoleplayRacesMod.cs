...
namespace vsroleplayraces.src
{
    public class VSRoleplayRacesMod : ModSystem
    {
        ...
        {
            this.races.Clear();
            this.races.Add("human", new RaceDefaultSettings() { raceCode = "human", bodyCode = "skin11", hairBase = "shortspiky", hairColor = 17, mustache = "none", beard = "none", hairExtra = "none", strength = 85, stamina = 85, agility = 80, dexterity = 75, intelligence = 75, wisdom = 75, charisma = 75, alignment = AlignmentType.Neutral, description = "Humans make the most of being somewhat average at everything - sure they may not be the strongest or most intelligent but their high fertility rate as a race allows them compete with other races by merely applying more bodies to a problem" });
            this.races.Add("darkelf", new RaceDefaultSettings() { raceCode = "darkelf", bodyCode = "skin4", hairBase = "combed", hairColor = 0, mustache = "none", beard = "none", hairExtra = "none", strength = 70, stamina = 70, agility = 90, dexterity = 75, intelligence = 109, wisdom = 83, charisma = 65, alignment = AlignmentType.Evil, description = "For every pure elf that stands under the blazing sun there lays beneath the world a Dark Elf. This matriarchal society is fueled equally by the lure of power and pure hatred and malice for one another and, above all, the lesser races." });
